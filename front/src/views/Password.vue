...
<template>
  <div style="width: 40%;margin-top: 30px;">
    ...
    <el-form style="width: 80%; margin: 0 auto" label-width="110px" :model="state.form" :rules="rules" ref="ruleFormRef">
      <el-form-item label="Please enter the original password" prop="password">
        <el-input show-password v-model="state.form.password"></el-input>
      </el-form-item>
      <el-form-item label="Please enter new password" prop="newPassword">
        <el-input show-password v-model="state.form.newPassword"></el-input>
      </el-form-item>
      <el-form-item label="Please confirm your new password" prop="confirmPassword">
